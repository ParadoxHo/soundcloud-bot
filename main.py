...
class MusicBot:
    ...
    async def handle_search(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # Выполняем поиск
            search_results = await self._perform_search(query, user_data)
    ...
    async def _perform_search(self, query: str, user_data: dict) -> list:
        """Выполняет поиск через YouTube"""
        ydl_opts = {
